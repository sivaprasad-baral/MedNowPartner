...
public class ConfirmedOrderFragment extends Fragment implements NewOrderAdapter.OrderListClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.confirmed_order_recycler_view);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(Objects.requireNonNull(container).getContext()));
        recyclerView.setAdapter(new NewOrderAdapter(container.getContext(),new ArrayList<User>(),ConfirmedOrderFragment.this));
        ...
        databaseReferenceOrders.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if(Objects.requireNonNull(order).getPartnerId().equals(firebaseUser.getUid()) && order.getOrderStatus() == Order.ORDER_CONFIRMED_BY_CUSTOMER) {
                        orders.add(order);
                    }
                }
                if(orders.isEmpty()) {
                    String orderHeader = "All confirmed orders are clear";
    ...
    private void displayOrdersList(final ViewGroup container) {
        ...
        databaseReferenceCustomers.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                String orderHeader = "Confirmed orders";
                OrderList.textViewHeader.setText(orderHeader);
                recyclerView.setAdapter(new NewOrderAdapter(container.getContext(),customers,ConfirmedOrderFragment.this));
            }
